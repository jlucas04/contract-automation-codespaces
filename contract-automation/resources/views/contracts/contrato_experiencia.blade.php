<!-- resources/views/contracts/contrato_experiencia.blade.php -->
<!DOCTYPE html>
<html lang="pt-br">
<head><meta charset="UTF-8"><title>Contrato de Experiência</title>
    <style>
        body {
...
<h2>CONTRATO DE TRABALHO - EXPERIÊNCIA</h2>
...
<div class="clause"><strong>1ª – OBJETO:</strong> Avaliação do EMPREGADO por período de experiência de {{ $collaborator->end_date ? \Carbon\Carbon::parse($collaborator->end_date)->diffInDays(\Carbon\Carbon::now()) : '____' }} dias.</div>
